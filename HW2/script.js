...
function displayImages() {  
  ...
  images.forEach(imageSrc => {  
    ...
    imgElement.style.cursor = 'pointer'; // Menampilkan kursor pointer saat hover  

    // Event untuk menampilkan gambar di Hover_gallery saat mouseover  
    imgElement.onmouseover = () => showImage(imageSrc);  

    // Event untuk menghapus gambar di Hover_gallery saat mouseout  
    imgElement.onmouseout = () => {  
      HoverGallery.innerHTML = ''; // Hapus gambar besar saat mouse keluar  
    };  
